 ...
 */
public class DS3024RB extends DiskArray {

    protected DS3024RB(String ip, String community, String name, int snmpVersion) {
        super(ip, community, name, snmpVersion);
    }

    public DS3024RB(String ip, String community, String name) {
    ...
    protected void collectSensorData(SnmpManager manager) throws IOException {
        ...
        addSensor(getTemperature(manager, ".1.3.6.1.4.1.1714.1.1.9.1.%d.25"));
